...
public class MainActivity extends Activity {
    ...
    private Button btn_active, btn_recharge, btn_consume, btn_loss;
    ...
    private void init() {
        ...
        btn_recharge.setOnClickListener(new rechargeOnClick());
    ...
    //recharge
    private class rechargeOnClick implements View.OnClickListener{
        public void onClick(View v) { toActivity(RechargeActivity.class);}
    }
    //consume
