...
public class ConsumeAction extends Activity {
    ...
    private Long pay;
    final private String URL = BasicURL.getBasicURL() + "record/consume/";
    ...
    private void consume() throws JSONException {
        ...
        final Long newBalance = cardJSON.getLong("balance") - pay;

        if (content == null || content.equals("")) {
            toastInfo("此卡为空,无法识别");
        } else if (cardJSON.getInt("status") != 1) {
            toastInfo("此卡已注销,无法支付");
